...
INSERT INTO User (id, office_id, doc_id, citizenship_code, first_name, second_name, middle_name, position, phone, is_identified, version) VALUES
(1, 2, 1, 976, 'Рустам', 'Казахов', 'Рустамович', 'Верстальщик', '+7(900)000-00-11', true,0),
(2, 3, 2, 976, 'Жанбек', 'Ибадулы', 'Жанбекович', 'Водитель', '+7(910)222-00-11', true,0),
(3, 4, 3, 976, 'Искандер', 'Махамбетов', 'Искандерочич', 'Завхоз', '+7(915)717-02-16', true,0),
(4, 6, 4, 643, 'Алексей', 'Стрельников', 'Иванович', 'Сотрудник охраны', '+7(911)656-42-13', true,0),
(5, 7, 5, 319, 'Сулико', 'Тереберидзе', 'Витальевна', 'Управляющая', '+7(922)491-45-34', true,0),
(6, 7, 6, 319, 'Гиви', 'Гелашвили', 'Гочаевич', 'Повар', '+7(922)491-45-35', true,0),
(7, 7, 7, 319, 'Отар', 'Алиев', 'Ревазович', 'Закупщик', '+7(922)491-45-36', true,0),
(8, 8, 8, 643, 'Владимир', 'Мрачков', 'Витальевич', 'Дизайнер', '+7(910)656-45-16', true,0),
(9, 9, 9, 643, 'Константин', 'Елпанов', 'Семёнович', 'Заместитель директора', '+7(910)343-55-92', true,0);
